...
|&#9745;|OctopInf|Workload-aware inference serving for edge video analytics: fine-grained resource allocation, adaptive batching and spatiotemporal co-location of tasks on GPUs.|[`octopinf`](EdgeScheduler/schedulers/retraining/octopinf.py)|
